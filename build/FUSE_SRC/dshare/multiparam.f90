...
! Modified by Martyn Clark to separate derived types from shared data, 12/2025
! ---------------------------------------------------------------------------------------
MODULE multiparam
 USE nrtype
 ...
 TYPE(PARADJ), DIMENSION(:), allocatable :: APARAM      ! all model parameter sets; DK/2008/10/21: explicit null
